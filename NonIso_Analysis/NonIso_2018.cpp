void NonIso_2018() {
 ...
 // gStyle->SetOptLogx(1); 
  ...
  //Open root file 
  TFile *DATA = TFile::Open("/home/snuintern1/skflat/SKFlatOutput/Run2Legacy_v3/NonIsoSec/2018/DATA/NonIsoSec_SingleMuon.root");
...
//  l->Draw();
  ...
  //Save as pdf file
  c1->SaveAs("./output/2018/Loose/pp_dimuon_DATA.pdf");
  c2->SaveAs("./output/2018/Loose/mm_dimuon_DATA.pdf");
  c3->SaveAs("./output/2018/Loose/ratio_dimuon_DATA.pdf");
  c4->SaveAs("./output/2018/Tight/pp_dimuon_DATA.pdf");
  c5->SaveAs("./output/2018/Tight/mm_dimuon_DATA.pdf");
  c6->SaveAs("./output/2018/Tight/ratio_dimuon_DATA.pdf");
