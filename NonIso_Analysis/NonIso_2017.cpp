void NonIso_2017() {
 ...
 // gStyle->SetOptLogx(1); 
  ...
  //Open root file 
  TFile *DATA = TFile::Open("/home/snuintern1/skflat/SKFlatOutput/Run2Legacy_v3/NonIsoSec/2017/DATA/NonIsoSec_SingleMuon.root");
...
//  l->Draw();
  ...
  //Save as pdf file
  c1->SaveAs("./output/2017/Loose/pp_dimuon_DATA.pdf");
  c2->SaveAs("./output/2017/Loose/mm_dimuon_DATA.pdf");
  c3->SaveAs("./output/2017/Loose/ratio_dimuon_DATA.pdf");
  c4->SaveAs("./output/2017/Tight/pp_dimuon_DATA.pdf");
  c5->SaveAs("./output/2017/Tight/mm_dimuon_DATA.pdf");
  c6->SaveAs("./output/2017/Tight/ratio_dimuon_DATA.pdf");
