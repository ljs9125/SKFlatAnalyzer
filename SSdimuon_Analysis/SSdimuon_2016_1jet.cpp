void SSdimuon_2016_1jet() {
 ...
 // gStyle->SetOptLogx(1); 
  ...
  TH1F *h1 = (TH1F*)DATA->Get("DATA/POGLoose_Central/Mll_pp_1jet");
  TH1F *h2 = (TH1F*)DATA->Get("DATA/POGLoose_Central/Mll_mm_1jet");

  TH1F *h4 = (TH1F*)DATA->Get("DATA/POGTight_Central/Mll_pp_1jet");
  TH1F *h5 = (TH1F*)DATA->Get("DATA/POGTight_Central/Mll_mm_1jet");
...
//  l->Draw();
  ...
  //Save as pdf file
  c3->SaveAs("./output/DATA/2016/Loose/ratio_dimuon_1jet.pdf");
  c6->SaveAs("./output/DATA/2016/Tight/ratio_dimuon_1jet.pdf");
