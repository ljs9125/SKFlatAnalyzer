...
void SSdimuon::initializeAnalyzer(){


  //==== I defined "vector<TString> MuonIDs;" in Analyzers/include/SSdimuon.h
  MuonIDs = {    
  ...
  //==== I defined "TString IsoMuTriggerName;" and "double TriggerSafePtCut;" in Analyzers/include/SSdimuon.h 
  ...
  cout << "[SSdimuon::initializeAnalyzer] IsoMuTriggerName = " << IsoMuTriggerName << endl;
  cout << "[SSdimuon::initializeAnalyzer TriggerSafePtCut = " << TriggerSafePtCut << endl;
...
void SSdimuon::executeEvent(){
  ...
  //==== So, I defined "vector<Muon> AllMuons;" in Analyzers/include/SSdimuon.h,
  ...
  //==== I defined "double weight_Prefire;" in Analyzers/include/SSdimuon.h
...
void SSdimuon::executeEventFromParameter(AnalyzerParameter param){
